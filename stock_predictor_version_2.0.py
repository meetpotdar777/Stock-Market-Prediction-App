...
# --- Feature Engineering Function (extracted for reusability) ---
def add_features(df, lag_days):
    ...
    # BUG FIX: Changed 'signal_windows' to 'window' for ta.momentum.stoch_signal
    ...
    feature_cols_to_lag = [
        ...
        'ATR', 'OBV',
        'BB_Width', 'BB_Percent_B', 'Stoch_K', 'Stoch_D', 'ROC', 'CMF' # Added new indicators to lag
    ]
...
if __name__ == "__main__":
    ...
    if trained_model is not None and fitted_scaler is not None and feature_columns_loaded:
        ...
        try:
            ...
            max_indicator_window = max(10, 20, 14, MAX_MACD_WINDOW) 
